...
COPY Calendar FROM 'E:/MyLearnings/Sql/wiley-da-with-sql/Wiley/data/Calendar.txt'
...
COPY Campaigns FROM 'E:/MyLearnings/Sql/wiley-da-with-sql/Wiley/data/Campaigns.txt'
    WITH HEADER NULL 'NULL' DELIMITER '	' CSV;
...
COPY Customers FROM 'E:/MyLearnings/Sql/wiley-da-with-sql/Wiley/data/Customers.txt'
    WITH HEADER NULL 'NULL' DELIMITER '	' CSV;
...
COPY OrderLines FROM 'E:/MyLearnings/Sql/wiley-da-with-sql/Wiley/data/OrderLines.txt'
    WITH HEADER NULL 'NULL' DELIMITER '	' CSV;
...
COPY Orders FROM 'E:/MyLearnings/Sql/wiley-da-with-sql/Wiley/data/Orders.txt'
...
COPY Products FROM 'E:/MyLearnings/Sql/wiley-da-with-sql/Wiley/data/Products.txt'
    WITH HEADER NULL 'NULL' DELIMITER '	' CSV;
...
COPY Subscribers FROM 'E:/MyLearnings/Sql/wiley-da-with-sql/Wiley/data/Subscribers.txt'
    WITH HEADER NULL 'NULL' DELIMITER '	' CSV;
...
COPY ZipCensus FROM 'E:/MyLearnings/Sql/wiley-da-with-sql/Wiley/data/ZipCensus.txt'
...
COPY ZipCounty FROM 'E:/MyLearnings/Sql/wiley-da-with-sql/Wiley/data/ZipCounty.txt'
    WITH HEADER NULL 'NULL' DELIMITER '	' ENCODING 'LATIN1'  CSV;
